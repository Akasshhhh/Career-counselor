        ...
        <div className="flex-1 flex flex-col h-full min-w-0 overflow-hidden">
          ...
          <div className="md:hidden flex items-center justify-between border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <MobileSidebar
              ...
              onSelectSession={handleSelectSession}
            />
            <h1 className="font-semibold text-lg truncate mx-4">Dashboard</h1>
            ...
            <div className="h-full flex flex-col items-center justify-center p-4">
              <div className="max-w-md text-center space-y-6">
                ...
                <div className="md:hidden">
                  <Button onClick={() => router.push('/dashboard')} variant="ghost" className="hidden" />
                  <MobileSidebar
                    selectedSessionId={undefined}
                    onSelectSession={(id) => router.push(`/dashboard/${id}`)}
                  />
                </div>
